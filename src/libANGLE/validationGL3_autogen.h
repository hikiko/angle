...
bool ValidateBindFragDataLocation(const Context * context, ShaderProgramID programPacked, GLuint color, const GLchar * name);
...
bool ValidateFramebufferTexture1D(const Context * context, GLenum target, GLenum attachment, TextureTarget textargetPacked, TextureID texturePacked, GLint level);
bool ValidateFramebufferTexture3D(const Context * context, GLenum target, GLenum attachment, TextureTarget textargetPacked, TextureID texturePacked, GLint level, GLint zoffset);
...
// GL 3.1
bool ValidateGetActiveUniformName(const Context * context, ShaderProgramID programPacked, GLuint uniformIndex, GLsizei bufSize, const GLsizei * length, const GLchar * uniformName);
bool ValidatePrimitiveRestartIndex(const Context * context, GLuint index);

// GL 3.2
bool ValidateMultiDrawElementsBaseVertex(const Context * context, PrimitiveMode modePacked, const GLsizei * count, DrawElementsType typePacked, const void *const* indices, GLsizei drawcount, const GLint * basevertex);
bool ValidateProvokingVertex(const Context * context, ProvokingVertexConvention modePacked);
bool ValidateTexImage2DMultisample(const Context * context, GLenum target, GLsizei samples, GLenum internalformat, GLsizei width, GLsizei height, GLboolean fixedsamplelocations);
bool ValidateTexImage3DMultisample(const Context * context, GLenum target, GLsizei samples, GLenum internalformat, GLsizei width, GLsizei height, GLsizei depth, GLboolean fixedsamplelocations);

// GL 3.3
bool ValidateBindFragDataLocationIndexed(const Context * context, ShaderProgramID programPacked, GLuint colorNumber, GLuint index, const GLchar * name);
...
bool ValidateGetFragDataIndex(const Context * context, ShaderProgramID programPacked, const GLchar * name);
bool ValidateGetQueryObjecti64v(const Context * context, QueryID idPacked, GLenum pname, const GLint64 * params);
bool ValidateGetQueryObjectui64v(const Context * context, QueryID idPacked, GLenum pname, const GLuint64 * params);
bool ValidateMultiTexCoordP1ui(const Context * context, GLenum texture, GLenum type, GLuint coords);
bool ValidateMultiTexCoordP1uiv(const Context * context, GLenum texture, GLenum type, const GLuint * coords);
bool ValidateMultiTexCoordP2ui(const Context * context, GLenum texture, GLenum type, GLuint coords);
bool ValidateMultiTexCoordP2uiv(const Context * context, GLenum texture, GLenum type, const GLuint * coords);
bool ValidateMultiTexCoordP3ui(const Context * context, GLenum texture, GLenum type, GLuint coords);
bool ValidateMultiTexCoordP3uiv(const Context * context, GLenum texture, GLenum type, const GLuint * coords);
bool ValidateMultiTexCoordP4ui(const Context * context, GLenum texture, GLenum type, GLuint coords);
bool ValidateMultiTexCoordP4uiv(const Context * context, GLenum texture, GLenum type, const GLuint * coords);
...
bool ValidateVertexAttribP1ui(const Context * context, GLuint index, GLenum type, GLboolean normalized, GLuint value);
bool ValidateVertexAttribP1uiv(const Context * context, GLuint index, GLenum type, GLboolean normalized, const GLuint * value);
bool ValidateVertexAttribP2ui(const Context * context, GLuint index, GLenum type, GLboolean normalized, GLuint value);
bool ValidateVertexAttribP2uiv(const Context * context, GLuint index, GLenum type, GLboolean normalized, const GLuint * value);
bool ValidateVertexAttribP3ui(const Context * context, GLuint index, GLenum type, GLboolean normalized, GLuint value);
bool ValidateVertexAttribP3uiv(const Context * context, GLuint index, GLenum type, GLboolean normalized, const GLuint * value);
bool ValidateVertexAttribP4ui(const Context * context, GLuint index, GLenum type, GLboolean normalized, GLuint value);
bool ValidateVertexAttribP4uiv(const Context * context, GLuint index, GLenum type, GLboolean normalized, const GLuint * value);
