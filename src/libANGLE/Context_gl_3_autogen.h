...
#define ANGLE_GL_3_CONTEXT_API \
    ...
    void  framebufferTexture1D(GLenum target, GLenum attachment, TextureTarget textargetPacked, TextureID texturePacked, GLint level); \
    ...
    void  getActiveUniformName(ShaderProgramID programPacked, GLuint uniformIndex, GLsizei bufSize, GLsizei * length, GLchar * uniformName); \
