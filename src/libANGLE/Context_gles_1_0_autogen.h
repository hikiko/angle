...
#define ANGLE_GLES_1_0_CONTEXT_API \
    ...
    void  getTexEnvfv(TextureEnvTarget targetPacked, TextureEnvParameter pnamePacked, GLfloat * params); \
    void  getTexEnviv(TextureEnvTarget targetPacked, TextureEnvParameter pnamePacked, GLint * params); \
    void  getTexEnvxv(TextureEnvTarget targetPacked, TextureEnvParameter pnamePacked, GLfixed * params); \
    ...
    void  texEnvfv(TextureEnvTarget targetPacked, TextureEnvParameter pnamePacked, const GLfloat * params); \
    void  texEnvi(TextureEnvTarget targetPacked, TextureEnvParameter pnamePacked, GLint param); \
    void  texEnviv(TextureEnvTarget targetPacked, TextureEnvParameter pnamePacked, const GLint * params); \
    void  texEnvx(TextureEnvTarget targetPacked, TextureEnvParameter pnamePacked, GLfixed param); \
    void  texEnvxv(TextureEnvTarget targetPacked, TextureEnvParameter pnamePacked, const GLfixed * params); \
