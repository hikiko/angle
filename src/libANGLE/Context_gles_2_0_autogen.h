...
#define ANGLE_GLES_2_0_CONTEXT_API \
    ...
    void  bufferData(BufferBinding targetPacked, GLsizeiptr size, const void * data, BufferUsage usagePacked); \
    void  bufferSubData(BufferBinding targetPacked, GLintptr offset, GLsizeiptr size, const void * data); \
    ...
    void  compressedTexImage2D(TextureTarget targetPacked, GLint level, GLenum internalformat, GLsizei width, GLsizei height, GLint border, GLsizei imageSize, const void * data); \
    void  compressedTexSubImage2D(TextureTarget targetPacked, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLenum format, GLsizei imageSize, const void * data); \
    void  copyTexImage2D(TextureTarget targetPacked, GLint level, GLenum internalformat, GLint x, GLint y, GLsizei width, GLsizei height, GLint border); \
    void  copyTexSubImage2D(TextureTarget targetPacked, GLint level, GLint xoffset, GLint yoffset, GLint x, GLint y, GLsizei width, GLsizei height); \
    ...
    void  drawElements(PrimitiveMode modePacked, GLsizei count, DrawElementsType typePacked, const void * indices); \
    void  enable(GLenum cap); \
    void  enableVertexAttribArray(GLuint index); \
    void  finish(); \
    void  flush(); \
    void  framebufferRenderbuffer(GLenum target, GLenum attachment, GLenum renderbuffertarget, RenderbufferID renderbufferPacked); \
    void  framebufferTexture2D(GLenum target, GLenum attachment, TextureTarget textargetPacked, TextureID texturePacked, GLint level); \
    ...
    void  getActiveAttrib(ShaderProgramID programPacked, GLuint index, GLsizei bufSize, GLsizei * length, GLint * size, GLenum * type, GLchar * name); \
    void  getActiveUniform(ShaderProgramID programPacked, GLuint index, GLsizei bufSize, GLsizei * length, GLint * size, GLenum * type, GLchar * name); \
    void  getAttachedShaders(ShaderProgramID programPacked, GLsizei maxCount, GLsizei * count, ShaderProgramID * shadersPacked); \
    ...
    void  getProgramInfoLog(ShaderProgramID programPacked, GLsizei bufSize, GLsizei * length, GLchar * infoLog); \
    void  getProgramiv(ShaderProgramID programPacked, GLenum pname, GLint * params); \
    void  getRenderbufferParameteriv(GLenum target, GLenum pname, GLint * params); \
    void  getShaderInfoLog(ShaderProgramID shaderPacked, GLsizei bufSize, GLsizei * length, GLchar * infoLog); \
    void  getShaderPrecisionFormat(GLenum shadertype, GLenum precisiontype, GLint * range, GLint * precision); \
    void  getShaderSource(ShaderProgramID shaderPacked, GLsizei bufSize, GLsizei * length, GLchar * source); \
    ...
    void  getUniformfv(ShaderProgramID programPacked, UniformLocation locationPacked, GLfloat * params); \
    void  getUniformiv(ShaderProgramID programPacked, UniformLocation locationPacked, GLint * params); \
    ...
    void  shaderBinary(GLsizei count, const ShaderProgramID * shadersPacked, GLenum binaryformat, const void * binary, GLsizei length); \
    void  shaderSource(ShaderProgramID shaderPacked, GLsizei count, const GLchar *const* string, const GLint * length); \
    ...
    void  texImage2D(TextureTarget targetPacked, GLint level, GLint internalformat, GLsizei width, GLsizei height, GLint border, GLenum format, GLenum type, const void * pixels); \
    ...
    void  texSubImage2D(TextureTarget targetPacked, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLenum format, GLenum type, const void * pixels); \
    ...
    void  uniform4f(UniformLocation locationPacked, GLfloat v0, GLfloat v1, GLfloat v2, GLfloat v3); \
    ...
    void  uniformMatrix2fv(UniformLocation locationPacked, GLsizei count, GLboolean transpose, const GLfloat * value); \
    void  uniformMatrix3fv(UniformLocation locationPacked, GLsizei count, GLboolean transpose, const GLfloat * value); \
    void  uniformMatrix4fv(UniformLocation locationPacked, GLsizei count, GLboolean transpose, const GLfloat * value); \
    ...
    void  vertexAttribPointer(GLuint index, GLint size, VertexAttribType typePacked, GLboolean normalized, GLsizei stride, const void * pointer); \
