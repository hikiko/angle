...
#define ANGLE_GLES_3_2_CONTEXT_API \
    ...
    void  drawElementsBaseVertex(PrimitiveMode modePacked, GLsizei count, DrawElementsType typePacked, const void * indices, GLint basevertex); \
    void  drawElementsInstancedBaseVertex(PrimitiveMode modePacked, GLsizei count, DrawElementsType typePacked, const void * indices, GLsizei instancecount, GLint basevertex); \
    void  drawRangeElementsBaseVertex(PrimitiveMode modePacked, GLuint start, GLuint end, GLsizei count, DrawElementsType typePacked, const void * indices, GLint basevertex); \
    void  enablei(GLenum target, GLuint index); \
    void  framebufferTexture(GLenum target, GLenum attachment, TextureID texturePacked, GLint level); \
    ...
    void  getnUniformfv(ShaderProgramID programPacked, UniformLocation locationPacked, GLsizei bufSize, GLfloat * params); \
    void  getnUniformiv(ShaderProgramID programPacked, UniformLocation locationPacked, GLsizei bufSize, GLint * params); \
    void  getnUniformuiv(ShaderProgramID programPacked, UniformLocation locationPacked, GLsizei bufSize, GLuint * params); \
    ...
    void  texBufferRange(TextureType targetPacked, GLenum internalformat, BufferID bufferPacked, GLintptr offset, GLsizeiptr size); \
    ...
    void  texStorage3DMultisample(TextureType targetPacked, GLsizei samples, GLenum internalformat, GLsizei width, GLsizei height, GLsizei depth, GLboolean fixedsamplelocations); \
