...
bool ValidateBitmap(const Context * context, GLsizei width, GLsizei height, GLfloat xorig, GLfloat yorig, GLfloat xmove, GLfloat ymove, const GLubyte * bitmap);
...
bool ValidateClearAccum(const Context * context, GLfloat red, GLfloat green, GLfloat blue, GLfloat alpha);
...
bool ValidateColor4d(const Context * context, GLdouble red, GLdouble green, GLdouble blue, GLdouble alpha);
...
bool ValidateColor4s(const Context * context, GLshort red, GLshort green, GLshort blue, GLshort alpha);
...
bool ValidateColor4us(const Context * context, GLushort red, GLushort green, GLushort blue, GLushort alpha);
...
bool ValidateCopyPixels(const Context * context, GLint x, GLint y, GLsizei width, GLsizei height, GLenum type);
...
bool ValidateDrawPixels(const Context * context, GLsizei width, GLsizei height, GLenum format, GLenum type, const void * pixels);
...
bool ValidateFeedbackBuffer(const Context * context, GLsizei size, GLenum type, const GLfloat * buffer);
...
bool ValidateFrustum(const Context * context, GLdouble left, GLdouble right, GLdouble bottom, GLdouble top, GLdouble zNear, GLdouble zFar);
...
bool ValidateGetTexGendv(const Context * context, GLenum coord, GLenum pname, const GLdouble * params);
...
bool ValidateGetTexImage(const Context * context, TextureTarget targetPacked, GLint level, GLenum format, GLenum type, const void * pixels);
...
bool ValidateMap1d(const Context * context, GLenum target, GLdouble u1, GLdouble u2, GLint stride, GLint order, const GLdouble * points);
bool ValidateMap1f(const Context * context, GLenum target, GLfloat u1, GLfloat u2, GLint stride, GLint order, const GLfloat * points);
bool ValidateMap2d(const Context * context, GLenum target, GLdouble u1, GLdouble u2, GLint ustride, GLint uorder, GLdouble v1, GLdouble v2, GLint vstride, GLint vorder, const GLdouble * points);
bool ValidateMap2f(const Context * context, GLenum target, GLfloat u1, GLfloat u2, GLint ustride, GLint uorder, GLfloat v1, GLfloat v2, GLint vstride, GLint vorder, const GLfloat * points);
...
bool ValidateMapGrid2d(const Context * context, GLint un, GLdouble u1, GLdouble u2, GLint vn, GLdouble v1, GLdouble v2);
bool ValidateMapGrid2f(const Context * context, GLint un, GLfloat u1, GLfloat u2, GLint vn, GLfloat v1, GLfloat v2);
...
bool ValidateOrtho(const Context * context, GLdouble left, GLdouble right, GLdouble bottom, GLdouble top, GLdouble zNear, GLdouble zFar);
...
bool ValidatePixelMapusv(const Context * context, GLenum map, GLsizei mapsize, const GLushort * values);
...
bool ValidateTexImage1D(const Context * context, GLenum target, GLint level, GLint internalformat, GLsizei width, GLint border, GLenum format, GLenum type, const void * pixels);
...
// GL 1.1
bool ValidateAreTexturesResident(const Context * context, GLsizei n, const GLuint * textures, const GLboolean * residences);
bool ValidateArrayElement(const Context * context, GLint i);
bool ValidateCopyTexImage1D(const Context * context, GLenum target, GLint level, GLenum internalformat, GLint x, GLint y, GLsizei width, GLint border);
bool ValidateCopyTexSubImage1D(const Context * context, GLenum target, GLint level, GLint xoffset, GLint x, GLint y, GLsizei width);
...
bool ValidateInterleavedArrays(const Context * context, GLenum format, GLsizei stride, const void * pointer);
bool ValidatePopClientAttrib(const Context * context);
bool ValidatePrioritizeTextures(const Context * context, GLsizei n, const GLuint * textures, const GLfloat * priorities);
bool ValidatePushClientAttrib(const Context * context, GLbitfield mask);
bool ValidateTexSubImage1D(const Context * context, GLenum target, GLint level, GLint xoffset, GLsizei width, GLenum format, GLenum type, const void * pixels);

// GL 1.2

// GL 1.3
bool ValidateCompressedTexImage1D(const Context * context, GLenum target, GLint level, GLenum internalformat, GLsizei width, GLint border, GLsizei imageSize, const void * data);
bool ValidateCompressedTexSubImage1D(const Context * context, GLenum target, GLint level, GLint xoffset, GLsizei width, GLenum format, GLsizei imageSize, const void * data);
bool ValidateGetCompressedTexImage(const Context * context, GLenum target, GLint level, const void * img);
...
bool ValidateMultiTexCoord3d(const Context * context, GLenum target, GLdouble s, GLdouble t, GLdouble r);
...
bool ValidateMultiTexCoord4d(const Context * context, GLenum target, GLdouble s, GLdouble t, GLdouble r, GLdouble q);
...
bool ValidateMultiTexCoord4i(const Context * context, GLenum target, GLint s, GLint t, GLint r, GLint q);
bool ValidateMultiTexCoord4iv(const Context * context, GLenum target, const GLint * v);
bool ValidateMultiTexCoord4s(const Context * context, GLenum target, GLshort s, GLshort t, GLshort r, GLshort q);
bool ValidateMultiTexCoord4sv(const Context * context, GLenum target, const GLshort * v);

// GL 1.4
bool ValidateFogCoordPointer(const Context * context, GLenum type, GLsizei stride, const void * pointer);
...
bool ValidateMultiDrawArrays(const Context * context, PrimitiveMode modePacked, const GLint * first, const GLsizei * count, GLsizei drawcount);
bool ValidateMultiDrawElements(const Context * context, PrimitiveMode modePacked, const GLsizei * count, DrawElementsType typePacked, const void *const* indices, GLsizei drawcount);
...
bool ValidateSecondaryColorPointer(const Context * context, GLint size, GLenum type, GLsizei stride, const void * pointer);
...
// GL 1.5
bool ValidateGetBufferSubData(const Context * context, GLenum target, GLintptr offset, GLsizeiptr size, const void * data);
bool ValidateGetQueryObjectiv(const Context * context, QueryID idPacked, GLenum pname, const GLint * params);
