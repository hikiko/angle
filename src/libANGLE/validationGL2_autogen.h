...
// GL 2.0
bool ValidateGetVertexAttribdv(const Context * context, GLuint index, GLenum pname, const GLdouble * params);
...
bool ValidateVertexAttrib3d(const Context * context, GLuint index, GLdouble x, GLdouble y, GLdouble z);
...
bool ValidateVertexAttrib4Nub(const Context * context, GLuint index, GLubyte x, GLubyte y, GLubyte z, GLubyte w);
...
bool ValidateVertexAttrib4d(const Context * context, GLuint index, GLdouble x, GLdouble y, GLdouble z, GLdouble w);
...
bool ValidateVertexAttrib4s(const Context * context, GLuint index, GLshort x, GLshort y, GLshort z, GLshort w);
